...
const ITEMS: readonly GalleryItem[] = [
  {
    src: '/images/mood-board/editorial/01-anchor-latch-hero.webp',
  ...
  {
    src: '/images/mood-board/editorial/03-porto-rooftop-dawn.webp',
  ...
  {
    src: '/images/mood-board/editorial/02-paracord-zipper-macro.webp',
  ...
  {
    src: '/images/mood-board/editorial/04-atelier-qc-bench.webp',
  ...
  {
    src: '/images/mood-board/editorial/05-gibraltar-ferry-stern.webp',
  ...
  {
    src: '/images/mood-board/editorial/06-studio-hardware-inventory.webp',
  ...
  {
    src: '/images/mood-board/editorial/07-hand-latch-lever.webp',
